        ...
        try {
            ...
            if (!this._initLogShown) {
                if (!this.baseURL) {
                    ...
                    console.log(`ℹ️ URL configurada: ${this.baseURL}`);
                    ...
                    try {
                        ...
                        console.log('ℹ️ El sistema funcionará en modo offline hasta obtener autenticación.');
                    }
                } else {
    ...
    async request(endpoint, options = {}) {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                const errorMsg = error.error || `Error ${response.status}`;
                if (isImportantRequest) {
