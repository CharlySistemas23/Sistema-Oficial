        ...
        this._salesChartInstance = new Chart(ctx, {
            ...
            options: {
                ...
                scales: {
                    x: {
                        grid: { display: false },
                        ticks: { color: '#9b93a8', font: { size: 10 } },
                        border: { display: false }
                    },
                    y: {
                        beginAtZero: true,
                        grid: { color: 'rgba(120,100,160,0.08)' },
                        ticks: {
                            color: '#9b93a8',
                            font: { size: 10 },
        ...
        this._donutChartInstance = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: hasData ? topSellers.map((_, i) => colors[i % colors.length]) : ['rgba(180,170,200,0.30)'],
                    borderWidth: 2,
