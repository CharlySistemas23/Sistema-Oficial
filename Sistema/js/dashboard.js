            ...
            try {
                ...
                if (!dailyProfit && typeof ProfitCalculator !== 'undefined' && ProfitCalculator.calculateDailyProfit && branchId) {
                    ...
                    try {
                        ...
                        // Solo usar el resultado si el revenue coincide con las ventas reales.
                        // ProfitCalculator puede devolver revenue=0 si el branch_id no coincide exactamente.
                        const calcRevenue = calc.revenue || 0;
                        if (calcRevenue > 0 || todayTotal === 0) {
                            dailyProfit = {
                                revenue: calcRevenue,
                        ...
                        // Si calcRevenue === 0 pero hay ventas reales, dejar dailyProfit = null
                        // para que el fallback manual corra con todaySales ya filtrados correctamente.
                    } catch (error) {
                    ...
                    if (!todayArrivals || todayArrivals.length === 0) {
                        ...
                        try {
                            ...
                            todayArrivals = arrivals.filter(a => 
                                (viewAllBranches || a.branch_id === branchId) &&
