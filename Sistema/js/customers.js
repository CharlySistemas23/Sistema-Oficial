        ...
        try {
            ...
            if (typeof API !== 'undefined' && API.baseURL && API.token && API.getCustomers) {
                try {
                    ...
                    customers = await API.getCustomers(filterBranchId ? `?branch_id=${filterBranchId}` : '');
            ...
            if (filterBranchId) {
                ...
                customers = customers.filter(c => {
                    if (!c.branch_id) return false; // Excluir clientes sin sucursal para usuarios normales
