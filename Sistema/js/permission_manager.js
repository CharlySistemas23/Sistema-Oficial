...
const PermissionManager = {
    ...
    /**
     * Verificar si el usuario tiene un permiso específico (considera sucursal actual si hay permissions_by_branch)
    ...
    hasPermission(permission) {
        ...
        if (user.role === 'admin' || user.role === 'master_admin' || user.permissions?.includes('all')) {
            return true;
        }

        const branchId = typeof BranchManager !== 'undefined' && BranchManager.getCurrentBranchId
