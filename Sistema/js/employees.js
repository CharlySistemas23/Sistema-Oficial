        ...
        const body = `
            <form id="employee-form" style="max-width: 600px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: var(--spacing-md);">
                    ...
                    <script>
                        // Mostrar/ocultar selector según el rol
                        ...
                        // Trigger inicial
                        if (document.getElementById('emp-role').value) {
                            document.getElementById('emp-role').dispatchEvent(new Event('change'));
                        }
                    </script>
                </div>
                <div class="form-group">
    ...
    async saveEmployee(employeeId) {
        try {
            ...
            if (role === 'master_admin' || role === 'admin' || role === 'manager') {
                ...
                // Roles normales: solo una sucursal
                branchId = branchInput?.value || null;
