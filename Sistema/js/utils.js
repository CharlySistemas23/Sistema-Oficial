...
const Utils = {
    ...
    /**
     * Calcular el segmento de un cliente de forma centralizada.
     * Fuente única de verdad usada por customers.js y reports.js.
     * @param {number} totalSpent - Total gastado por el cliente
     * @param {number} purchaseCount - Número de compras realizadas
     * @param {number|null} lastPurchaseDays - Días desde la última compra (null si nunca ha comprado)
     * @returns {string} Segmento: 'Nuevo' | 'Inactivo' | 'VIP' | 'Premium' | 'Regular' | 'Ocasional'
     */
