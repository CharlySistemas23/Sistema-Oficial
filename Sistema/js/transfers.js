        ...
        try {
            ...
            if (typeof API !== 'undefined' && API.baseURL && API.token && API.getTransfers) {
                try {
                    ...
                    // Esto asegura que transferencias sin branch_id se excluyan cuando se filtra por sucursal específica
                    if (filterBranchId) {
                        ...
                        allTransfers = allTransfers.filter(t => {
                            ...
                            // CRÍTICO: Excluir transferencias sin sucursales cuando se filtra por sucursal específica
                    ...
                    console.log(`✅ ${allTransfers.length} transferencias cargadas desde API (después de filtro estricto)`);
                } catch (apiError) {
