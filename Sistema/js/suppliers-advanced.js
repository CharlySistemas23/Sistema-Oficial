...
window.SuppliersAdvanced = {
    ...
    async deleteContract(contractId, supplierId) {
        if (!await Utils.confirm('¿Estás seguro de eliminar este contrato?')) return;
    ...
    generateReceiptHTML({ receiptNumber, payment, supplier, amount, date, method, branch, companyName = 'OPAL & CO' }) {
        const methodLabels = {
            'cash': 'Efectivo',
...
<body>
    ...
    <div class="footer">
        <p>Este documento es un comprobante de pago emitido por ${companyName}</p>
