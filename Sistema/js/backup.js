...
const BackupManager = {
    ...
    async createBackup() {
        try {
            ...
            // Si es QuotaExceededError, solo loguear como warning, no como error
            if (error.name === 'QuotaExceededError' || error.message.includes('quota')) {
                console.warn('⚠️ No se pudo crear backup automático: localStorage lleno. Limpia backups antiguos o usa la descarga manual.');
            } else {
