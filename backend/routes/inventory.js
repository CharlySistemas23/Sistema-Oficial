  ...
  try {
    ...
    if (error.code === '23505') { // Unique violation
      ...
      if (error.constraint === 'inventory_items_sku_key') {
        errorMessage = `El SKU "${sku}" ya existe. Si estás creando en una sucursal diferente, el sistema agregará automáticamente el prefijo de sucursal.`;
      } else if (error.constraint === 'inventory_items_barcode_key') {
        errorMessage = `El código de barras "${barcode}" ya existe`;
      }
